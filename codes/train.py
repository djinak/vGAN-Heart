...
rounds_for_evaluation=list(range(n_rounds))
...
val_imgs, val_vessels=train_imgs[np.delete(list(range(n_all_imgs)),train_indices),...], train_vessels[np.delete(list(range(n_all_imgs)),train_indices),...]
# set test dataset
...
for n_round in range(n_rounds):
    ...
    K.set_value(d.optimizer.learning_rate, scheduler.get_learning_rate())    
    K.set_value(gan.optimizer._lr, scheduler.get_lr())    
